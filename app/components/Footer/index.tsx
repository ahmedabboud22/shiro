...
const products: ProductType[] = [
  ...
  },
  {
    id: 2,
    section: "Contact Us",
    link: ["Office Address", "Phone", "Email", "Landline"],
  },
  {
    id: 3,
    section: "Friends",
    link: ["Chi Agency", "Di Mare Restautant"],
  },
  {
    id: 4,
    section: "Owners",
    link: ["Mohamad Shaheen"],
  },
];
      ...
      <div className="mx-auto max-w-2xl pt-48 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-4">
            <h3 className="text-white text-4xl font-semibold leading-relaxed mb-4 lg:mb-20 ">
              {" "}
